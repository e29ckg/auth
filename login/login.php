...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($data->redirect)){
        ...
        $redirect =  $_SERVER['REQUEST_SCHEME'] . '://'. $_SERVER['HTTP_HOST'] . '/main/';
    }
    ...
    if( !empty($row) && password_verify($password, $row->password_hash) ) {
        ...
        $_SESSION['LOGIN_BY']= $LOGIN_BY;
        $_SESSION['__id'] = $row->id;
        // $_SESSION['__expire'] = time() + 1;
        $_SESSION['__expire'] = time() + 60 * 60 * 8;
